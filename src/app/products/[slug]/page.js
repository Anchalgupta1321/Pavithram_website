...
export default function ProductDetailPage({ params }) {
  ...
  // Extract slug from URL using React.use() wrapper (Next 13+ standard for params in client components if needed, or simply use params directly depending on version. We'll use simple useEffect to avoid sync issues)
  useEffect(() => {
